...
export const initialLeads: Lead[] = [
  ...
  { id: 'lead-4', name: 'Nuevo Lead Alfa (Urgente)', city: 'Barranquilla', lastContact: 'Hace 4 días', interestType: 'planta-solar', status: 'Nuevo Lead', phone: '318 111 2233', email: 'alfa@cliente.com', creationDate: threeDaysAgo.toISOString(), source: 'Página Web', collectedData: {}, advisorId: 'user-2', advisorName: 'Ana Gómez' },
